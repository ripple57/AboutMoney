package com.ripple.lendmoney.widget.cameralibrary;
...
import com.ripple.lendmoney.widget.cameralibrary.utils.SystemUtils;
    ...
    private void captrue() {
        mCamera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                intent.putExtra(Constant.IntentKeyFilePath, img_path);
                setResult(Constant.IntentResultCode, intent);
                finish();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_take_picture) {
            ...
            if (lightOn) {
                ...
                btn_flash.setBackground(getResources().getDrawable(R.drawable.video_flash_close));
                lightOn = false;
            } else {
                CameraUtil.getInstance().turnLightOn(mCamera);
                btn_flash.setBackground(getResources().getDrawable(R.drawable.video_flash_open));
                lightOn = true;
            }
